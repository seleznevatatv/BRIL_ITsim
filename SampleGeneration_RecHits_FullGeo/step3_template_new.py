...
# with command line options: step3 --conditions auto:phase2_realistic_T21 --pileup_input das:/RelValMinBias_14TeV/1/GEN-SIM -n 10 --era Phase2C11 --eventcontent FEVTDEBUGHLT,MINIAODSIM,DQM -s RAW2DIGI,L1Reco,RECO,RECOSIM,PAT,VALIDATION:@phase2Validation+@miniAODValidation,DQM:@phase2+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --pileup AVE_200_BX_25ns --geometry Extended2026D63
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_RECOSIM_PAT_VALIDATION_DQM_PU.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_RECOSIM_PAT_VALIDATION_DQM_PU_inMINIAODSIM.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_RECOSIM_PAT_VALIDATION_DQM_PU_inDQM.root'),
